...
import com.example.pan.mobileplayer.activity.view.VideoView;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SHOW_SPEED://显示网络速度
                    //得到网络速度
                    String netspeed = utils.getNetSpeed(MyselfVideoPlayer.this);
...
//            videoview.setVideoSize(mediaPlayer.getVideoWidth(),mediaPlayer.getVideoHeight());
    ...
    class MyOnErrorListener implements MediaPlayer.OnErrorListener {
        ...
        public boolean onError(MediaPlayer mediaPlayer, int what, int extra) {
            ...
            //格式不支持-跳转到vitamio万能播放器
            startViatmioPlayer();
            return false;
        }
    }

    private void startViatmioPlayer() {
        if (videoview != null) {
