...
public class SearchAdapter extends BaseAdapter {
    ...
    private final List<ParseTools.ItemData> mediaItems;

    public SearchAdapter(Context context, List<ParseTools.ItemData> mediaItems){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ParseTools.ItemData mediaItem = mediaItems.get(position);
